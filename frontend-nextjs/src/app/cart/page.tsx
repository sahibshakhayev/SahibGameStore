...
const CartPage = () => {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      router.push('/orders') // Navigate to orders page after successful checkout
    } catch (err) {
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-300 font-medium text-lg">Loading your cart...</p>
        </div>
      </div>
    )
  }
  ...
  if (!cart || cart.items.length === 0) {
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center bg-gray-800 p-12 rounded-2xl shadow-lg max-w-md mx-4 border border-gray-700">
          ...
          <p className="text-gray-400 mb-8">Discover amazing games and start building your collection!</p>
          <div className="space-y-4">
            <Link 
              href="/games" 
              className="inline-flex items-center px-6 py-3 bg-cyan-600 text-white font-semibold rounded-lg hover:bg-cyan-700 focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition-colors"
            >
              Browse Games
            ...
            <button 
              ...
              className="block mx-auto px-4 py-2 text-gray-400 hover:text-gray-300 transition-colors"
            >
              Refresh
            </button>
          </div>
      ...
      <div className="container mx-auto px-6 py-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-4 mb-2">
                ...
                <button
                  onClick={handleManualRefresh}
                  className="inline-flex items-center px-3 py-1 text-sm text-gray-400 hover:text-gray-300 border border-gray-600 rounded-md hover:bg-gray-800 transition-colors"
                >
            ...
            <div className="hidden md:block">
              <div className="bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-700">
                ...
                <p className="text-2xl font-bold text-cyan-400">${cart.total.toFixed(2)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
            ...
            <div className="bg-gray-800 rounded-2xl shadow-sm border border-gray-700 overflow-hidden">
              <div className="p-6 border-b border-gray-700 bg-gradient-to-r from-gray-800 to-gray-750">
                <div className="flex items-center justify-between">
                  ...
                  <span className="bg-cyan-600/20 text-cyan-400 text-sm font-medium px-3 py-1 rounded-full border border-cyan-600/30">
                    {cart.items.length}
                  </span>
                </div>
              </div>
              ...
              <div className="divide-y divide-gray-700">
                {cart.items.map((item: CartItem) => (
                  <div key={item.gameId} className="p-8 hover:bg-gray-700/30 transition-all duration-200 group">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                      <div className="flex-1 mb-6 lg:mb-0">
                        <div className="flex items-start space-x-4">
                          <div className="w-16 h-16 bg-gradient-to-br from-cyan-600/20 to-cyan-700/20 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform border border-cyan-600/30">
                            <Image 
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-8">
                        <div className="flex items-center space-x-4 mb-6 sm:mb-0">
                          <label className="text-sm font-semibold text-gray-300 whitespace-nowrap">Quantity:</label>
                          <div className="relative">
                            <input
                              ...
                              className="w-20 px-3 py-2 border border-gray-600 text-white rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 text-center font-semibold bg-gray-700 disabled:bg-gray-600"
                        ...
                        <div className="flex items-center justify-between sm:block sm:text-right">
                          <div>
                            ...
                            <p className="text-2xl font-bold text-white mb-3">${item.subtotal.toFixed(2)}</p>
                            <button
                              onClick={() => handleRemoveFromCart(item.gameId)}
                              disabled={isRemoving[item.gameId]}
                              className="inline-flex items-center text-red-400 hover:text-red-300 text-sm font-medium disabled:opacity-50 transition-colors group/remove"
                            >
          ...
          <div className="xl:col-span-1">
            <div className="bg-gray-800 rounded-2xl shadow-sm border border-gray-700 overflow-hidden sticky top-8">
              {/* Order Summary */}
              <div className="p-6 border-b border-gray-700 bg-gradient-to-r from-green-600/10 to-emerald-600/10">
                <h2 className="text-xl font-semibold text-white flex items-center">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="border-t border-gray-700 pt-4">
                  <div className="flex justify-between items-center text-xl">
                    ...
                    <span className="font-bold text-green-400 text-2xl">${cart.total.toFixed(2)}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-700 p-6 bg-gray-750">
                ...
                {methods.length === 0 ? (
                  <div className="bg-amber-600/10 border border-amber-600/30 rounded-xl p-4 mb-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="text-amber-400 font-semibold text-sm mb-1">No payment methods found</p>
                        <p className="text-amber-300 text-sm">
                          Please add a payment method on your{' '}
                          <Link href="/account" className="underline hover:no-underline font-semibold">
                            Account Page
                          </Link>
                        </p>
                      </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <select
                        className="w-full px-4 py-3 border border-gray-600 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 bg-gray-700 text-white font-medium"
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-300 mb-3">Shipping Address</label>
                      <textarea
                        className="w-full px-4 py-3 border border-gray-600 text-white rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 resize-none bg-gray-700"
                        rows={4}
                        value={address}
                ...
                <button
                  ...
                  className="w-full mt-8 bg-gradient-to-r from-green-600 to-emerald-600 text-white py-4 px-6 rounded-xl font-bold hover:from-green-700 hover:to-emerald-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:from-gray-600 disabled:to-gray-700 disabled:cursor-not-allowed transition-all duration-200 text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
                  {isCheckingOut ? (
