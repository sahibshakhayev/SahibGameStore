...
namespace SahibGameStore.Infracstuture.Data.Context
{
    public static class DbInitializer
    {
        ...
        UserManager<IdentityUser> _userManager, RoleManager<IdentityRole> _roleManager)
        {
            ...
            shoppingCarts[0].AddItem(games[0], 1);
            shoppingCarts[0].AddItem(games[1], 1);
            shoppingCarts[0].AddItem(games[3], 1);

            shoppingCarts[1].AddItem(games[0], 1);
            shoppingCarts[1].AddItem(games[2], 1);
            shoppingCarts[1].AddItem(games[3], 1);
            ...
            var order1 = new Order(new Guid(userId1.Id), shoppingCarts[0], paymentMethod1, "Test Address");
            var order2 = new Order(new Guid(userId2.Id), shoppingCarts[1], paymentMethod2, "Test Address");
